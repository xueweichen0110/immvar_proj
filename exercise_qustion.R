# Apply it to ImmVar dataset and describe what you learned about biology of gene expression
# How would you apply this framework to a biological question you are interested in?
...
data_matrix <- exprobject@assayData$exprs

form <- ~ Age + (1|Individual) + (1|Tissue) + (1|Batch) #???
form_immvar <- ~ (1|cellType) + (1|Individual) + Age + + (1|Batch)  + (1|characteristics_ch1.1)
...
varPart_immvar <- fitExtractVarPartModel(data_matrix, form_immvar, info_exprobject)
